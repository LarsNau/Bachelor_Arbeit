...
In dieser Arbeit wird versucht das Problem der Ausrichtung von Bauteilen im 5d-Druck durch die Verwendung von tiefen neuralen Netzen zu lösen. Als Datensatz werden künstliche generierte Objekt verwendet.
...
Für das Neurale Netz wird eine angepasste Version von einem Bereits existierenden Neuralem Netz für die Merkmalsextraktion verwendet \cite{PointNet++}. Danach wird die Leistung des neuronalen Netzes evaluiert, 
