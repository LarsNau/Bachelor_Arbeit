...
Es lässt sich sagen, dass das beschriebene neurale Netz in der Lage ist, Bauteile für die additive Fertigung auszurichten. Eine geringere Abweichung von dem Optimum wäre wünschenswert, aber die erzielten Ergebnisse sind dennoch ausreichend, 
...
aber die Verbesserung ist nur gering. Insgesamt ist das beschriebene Verfahren ein akzeptabler Ansatz, um Bauteile in der additiven Fertigung auszurichten, wenn auch noch einige Verbesserungen möglich wären. Es ist für den praktischen Einsatz noch nicht denkbar.
