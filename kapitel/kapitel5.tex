...
Eine Abweichung von unter 10° ist in den meisten Fällen erreicht worden.
...
was auf eine gute Generalisierbarkeit des Netzes hinweist. Eine durchschnittliche Abweichung von unter 10 Grad ist für den Praxisfall häufig zu viel. 10 Grad reichen aus, um einer Fläche einen Überhang zu geben, was dem Sinn des 5d-Drucks widersprechen würde.
Das Ergebnis, wenn die Minimierung der Bewegung ignoriert wird ist in der Hinsicht vielversprechender mit 5 Grad. Es würde allerdings auch eine signifikante Erhöhung der Druckzeit mit sich bringen, da siech die Bewegung für jede Ausrichtung mehr als verdoppelt hat.
...
Die Minimierung der Bewegung des Bauteils während des Ausrichtens hatte eine kleine, aber sichtbaren Verkleinerung der benötigten Drehung ergeben. Der durchschnittliche Winkel, um den ein Teil gedreht werden muss, lag bei unter 40°. Ohne die Minimierung würde der durchschnittliche Drehwinkel bei über 45° liegen, also zufällig zwischen 0 und 90 Grad.
...
Es ist zusammengefasst für den praktischen Einsatz noch nicht praktikabel. 
