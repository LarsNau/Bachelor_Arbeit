...
Die Z-Invarianz sollte im optimalen Fall im 90 Grad Winkel zu dem Normalvektor einer Fläche liegen, dadurch wird die Fläche möglichst parallel zu der Achse der Druckerdüse gedreht. Eine Fläche, die parallel zu der Düse des Druckers ist, 
...
Dieses Neurale Netz wird eine Punktwolke beliebiger Größe zu der Z-Invarianz transformieren. Die Z-Invarianz wird in einem folgenden Abschnitt \ref{Konstruktion der Ausrichtung} zu einer Rotationsmatrix umgeformt. Mit dieser Rotationsmatrix lässt sich dann eine Drehung darstellen.
...
Nachdem für Punktwolke einer Fläche im Bauteil mit dem In Abschnitt Z-Invarianz. Dafür wird eine Abbildung von dem Vektor auf die Ergebnisse erlernt. Dieses Vorgehen wird Regression genannt. 
...
Die, in Abschnitt \ref{Punktwolken Transformation} berechnete, Z-Invarianz ist nicht genug, um eine Drehung darzustellen, um ein Bauteil drehen zu können ist eine Rotationsmatrix notwendig. Die Z-Invarianz wird zu einer Rotationsmatrix erweitert.
