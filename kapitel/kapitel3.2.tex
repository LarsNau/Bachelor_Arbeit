...
Die Methode "Farthest Point Sampling" wurde in dem Artikel \cite{Point} erstellt.
...
\begin{figure}[h]
    \begin{math} A \Subset P, (E,V) = G, \end{math}
    \begin{math} \forall \vec{a} \in A , \forall \vec{p} \in P: \left|  \left| \vec{a} - \vec{p}  \right| \right|_{2} \leq r \implies (p,a) \in E \end{math}
\end{figure}
