...
Eine Aufteilung von Datenpunkten in Gruppen wird Clustering genannt. Die Aufteilung in Gruppen basiert auf den Werten der Datenpunkte, Daten mit ähnlichen Werten kommen generell in dieselbe Gruppe. Die Gruppen werden auch Cluster genannt. 
...
Der benutze Algorithmus für das Clustering wurde in der Arbeit \cite{DBScann} erarbeitet.
...
Der Distanzwert auf der y-Achse in \ref{Beispiel von Hierachie Clustring als Dendrogramm} dient dabei als Fehlermaß für die Flächen. Wenn das Fehlermaß null ist, werden nur Flächen gefunden, die absolut Flach sind, 
...
Die Abbildung \ref{Beispielhafte Darstellung von DB-Scan Algorithmus} ist ein Beispiel für die Funktion von dem DB-Scan Algorithmus, der im Folgenden erklärt wird. 
...
aber nicht mindestens $minPts$ viele Punkte in seiner Nachbarschaft hat, dann ist dieser Punkt ein Randpunkt (Borderpoint), aber immer noch teil des Clusters.
